...
(function () {
  var q,
    ...
    r = "3.18.1",
    i = ".",
    o = "https://yui-s.yahooapis.com/",
    u = "yui3-js-enabled",
    d = "yui3-css-stamp",
    m = function () {},
    h = Array.prototype.slice,
    s = { "io.xdrReady": 1, "io.xdrResponse": 1, "SWF.eventHandler": 1 },
    ...
    k = function (z, y) {
      ...
      YUI.Env.core = z.Array.dedupe(
        [].concat(YUI.Env.core, ["loader-base", "loader-rollup", "loader-yui3"])
      );
      return x;
    },
    p = function (z, y) {
  ...
  q = {
    ...
    _init: function () {
      ...
      A = A ? "-" + A : A;
      B.config.loaderPath =
        YUI.config.loaderPath || "loader/loader" + A + ".js";
    },
    _setup: function (C) {
      var y,
        B = this,
    ...
    add: function (y, D, C, x) {
      x = x || {};
      var B = YUI.Env,
        E = { name: y, fn: D, version: C, details: x },
        F,
        A,
        z = B.versions;
      B.mods[y] = E;
    ...
    _attach: function (C, N) {
      ...
      for (G = 0; G < I; G++) {
        ...
        L.push(O);
        if (B && B.conditions[O]) {
          y.Object.each(B.conditions[O], function (Q) {
          ...
          if (!M) {
            ...
            for (F = 0; F < y.Env._missed.length; F++) {
              if (y.Env._missed[F] === O) {
                y.message(
                  "Found: " + O + " (was reported as missing earlier)",
                  "warn",
                  "yui"
                );
    ...
    _use: function (z, B) {
      ...
      var O,
        ...
        H = function (Y) {
          var W = Y || { success: true, msg: "not dynamic" },
            V,
            U,
            X = true,
            Z = W.data;
...
YUI.add(
  ...
  function (b) {
    ...
    i.isDate = function (v) {
      return (
        i.type(v) === "date" && v.toString() !== "Invalid Date" && !isNaN(v)
      );
    };
    ...
    i.isObject = function (x, w) {
      ...
      return (
        (x &&
          (v === "object" || (!w && (v === "function" || i.isFunction(x))))) ||
        false
      );
    };
    ...
    j.each = j.forEach = f._isNative(q.forEach)
      ...
      : function (z, x, y) {
          for (var w = 0, v = (z && z.length) || 0; w < v; ++w) {
            if (w in z) {
              x.call(y || b, z[w], w, z);
            }
          }
    ...
    b.cached = function (x, v, w) {
      ...
      return function (y) {
        var z =
          arguments.length > 1
            ? Array.prototype.join.call(arguments, m)
            : String(y);
        if (!(z in v) || (w && v[z] == w)) {
    ...
    var f = b.Lang,
      o = Object.prototype.hasOwnProperty,
      u,
      g = (b.Object = f._isNative(Object.create)
        ? function (v) {
      ...
      s = (g._hasEnumBug = !{ valueOf: 0 }.propertyIsEnumerable("valueOf")),
      p = (g._hasProtoEnumBug = function () {}.propertyIsEnumerable(
        "prototype"
      )),
    ...
    g.hasKey = h;
    g.keys = f._isNative(Object.keys)
      ? Object.keys
      : function (z) {
          if (!f.isObject(z)) {
...
YUI.add(
  ...
  function (d) {
    ...
    d.Get = e = {
      ...
      jsOptions: { autopurge: true, doc: d.config.scriptDoc || d.config.doc },
      ...
      _getEnv: function () {
        ...
        return (this._env = {
          ...
          cssLoad:
            ((!f.gecko && !f.webkit) ||
              f.gecko >= 9 ||
              f.compareVersions(f.webkit, 535.24) >= 0) &&
            !(f.chrome && f.chrome <= 18),
      ...
      _getTransaction: function (l, h) {
        ...
        for (j = 0, f = l.length; j < f; ++j) {
          ...
          d.mix(
            k,
            k.type === "js" ? this.jsOptions : this.cssOptions,
            false,
            null,
            0,
            true
      ...
      _load: function (g, h, f, j) {
        ...
        this._queue.push({ callback: j, transaction: i });
        this._next();
        return i;
      },
      _next: function () {
    ...
    a.prototype = {
      ...
      abort: function (f) {
        ...
        this._queue = [];
        this._waiting = 0;
        this.errors.push({ error: f || "Aborted" });
        this._finish();
      },
      execute: function (n) {
        var h = this,
      ...
      _createNode: function (h, g, j) {
        ...
        if (!b) {
          ...
          b = k.className === "a" ? {} : { for: "htmlFor", class: "className" };
        }
        for (f in g) {
      ...
      _insert: function (o) {
        ...
        if (i) {
          ...
          if (!l.cssLoad && g.gecko) {
            h.innerHTML =
              (o.attributes.charset
                ? '@charset "' + o.attributes.charset + '";'
                : "") +
              '@import "' +
              o.url +
              '";';
      ...
      _progress: function (h, g) {
        ...
        if (h) {
          g.error = h;
          this.errors.push({ error: h, request: g });
        }
...
YUI.add(
  ...
  function (b) {
    ...
    a("load", "0", { name: "io-nodejs", trigger: "io-base", ua: "nodejs" });
    a("load", "1", {
      ...
      test: function (h) {
        var f = h.config.doc,
          g =
            ...
            h.config.defaultGraphicEngine == "canvas",
    ...
    a("load", "5", {
      ...
      test: function (f) {
        ...
        return (
          ...
          (!d || !d.getContext || !d.getContext("2d"))
        );
      },
      trigger: "graphics",
    });
    ...
    a("load", "13", {
      ...
      test: function (d) {
        return (
          d.config.win &&
          "ontouchstart" in d.config.win &&
          !(d.UA.chrome && d.UA.chrome < 6)
        );
      },
      trigger: "dd-drag",
    });
...
YUI.add(
  ...
  function (d) {
    var c = d,
      e = "yui:log",
      a = "undefined",
      b = { debug: 1, info: 1, warn: 1, error: 1 };
    ...
    d.Loader.prototype = {
      ...
      getRequires: function (R) {
        ...
        if (R.skinnable) {
          ...
          r(YUI.Env.aliases, function (V, W) {
      ...
      _onProgress: function (x) {
        var w = this;
        if (w.onProgress) {
          w.onProgress.call(w.context, { name: x.url, data: x.data });
        }
      },
      _onFailure: function (A) {
        ...
        z = z.join(",");
        if (y) {
          y.call(this.context, { msg: z, data: this.data, success: false });
        }
      ...
      resolve: function (x, O) {
        ...
        var L = function (ab) {
          if (ab) {
            ...
            E = ab.fullpath
              ? P._filter(ab.fullpath, O[W])
              : P._url(ab.path, O[W], I.base || ab.base);
            if (ab.attributes || ab.async === false) {
              E = { url: E, async: ab.async };
              if (ab.attributes) {
            ...
            if (X) {
              for (W = 0; W < X; W++) {
                ...
                if (U && (U.combine || !U.ext)) {
                  ...
                  y =
                    (i.isValue(U.root) ? U.root : P.root) +
                    (U.path || U.fullpath);
...
YUI.add(
  ...
  function (a) {
    YUI.Env[a.version].modules = YUI.Env[a.version].modules || {
      ...
      "app-transitions-native": {
        condition: {
          ...
          test: function (d) {
            ...
            if (b && b.style) {
              return (
                "MozTransition" in b.style || "WebkitTransition" in b.style
              );
            }
            return false;
          },
      ...
      "attribute-core": { requires: ["yui-base"] },
      "attribute-events": { requires: ["event-custom"] },
      "attribute-extras": { requires: ["yui-base"] },
      autocomplete: {
        use: [
          "autocomplete-base",
          "autocomplete-sources",
      ...
      cssgrids: { optional: ["cssreset", "cssfonts"], type: "css" },
      "cssgrids-base": { optional: ["cssreset", "cssfonts"], type: "css" },
      "cssgrids-units": {
      ...
      datatype: { use: ["datatype-number", "datatype-date", "datatype-xml"] },
      "datatype-date": {
      ...
      graphics: { requires: ["node", "event-custom", "pluginhost", "matrix"] },
      "graphics-canvas": {
        condition: {
          name: "graphics-canvas",
          test: function (f) {
            var d = f.config.doc,
              e =
                ...
                f.config.defaultGraphicEngine == "canvas",
      ...
      "handlebars-base": { requires: ["escape"] },
      ...
      "history-hash-ie": {
        condition: {
          ...
          test: function (c) {
            ...
            return (
              c.UA.ie && (!("onhashchange" in c.config.win) || !b || b < 8)
            );
          },
          trigger: "history-hash",
        },
      ...
      "node-event-simulate": { requires: ["node-base", "event-simulate"] },
      "node-flick": {
      ...
      pjax: { requires: ["pjax-base", "io-base"] },
      "pjax-base": {
      ...
      "scrollview-paginator": { requires: ["plugin"] },
      ...
      "transition-timer": {
        condition: {
          ...
          test: function (e) {
            ...
            if (c && c.style) {
              b = !(
                "MozTransition" in c.style || "WebkitTransition" in c.style
              );
            }
            return b;
          },
...
YUI.add(
  ...
  function (b) {
    ...
    function c(Q) {
      ...
      Q = Q || {};
      c.superclass.constructor.call(T, Q);
      S = T.get(i);
      if (S) {
        if (S !== u) {
          L = S;
    ...
    l[J] = { value: O, readOnly: u };
    l[N] = { value: null, setter: "_setBB", writeOnce: u };
    l[v] = { valueFn: "_defaultCB", setter: "_setCB", writeOnce: u };
    l[H] = { value: null, validator: "_validTabIndex" };
    l[B] = { value: O, readOnly: u };
    l[y] = { value: O };
    l[P] = { value: u };
    l[A] = { value: D };
    l[d] = { value: D };
    l[a] = { value: {}, setter: "_strSetter", getter: "_strGetter" };
    l[i] = { value: O, writeOnce: u };
    ...
    b.extend(c, b.Base, {
      ...
      initializer: function (L) {
        var Q = this.get(N);
        if (Q instanceof r) {
          this._mapInstance(Q.get(q));
        }
        if (this._applyParser) {
          this._applyParser(L);
        }
      },
      _mapInstance: function (L) {
        if (!h[L]) {
          h[L] = this;
        }
      },
      ...
      _setCB: function (L) {
        return this.CONTENT_TEMPLATE === null
          ? this.get(N)
          : this._setBox(null, L, this.CONTENT_TEMPLATE);
      },
      ...
      _bindDOM: function () {
        var L = this.get(N).get(m),
          Q = c._hDocFocus;
        if (!Q) {
          Q = c._hDocFocus = L.on("focus", this._onDocFocus, this);
          Q.listeners = { count: 0 };
        }
        Q.listeners[b.stamp(this, true)] = true;
        Q.listeners.count++;
        if (C) {
      ...
      _onDocFocus: function (L) {
        var Q = c.getByNode(L.target),
          R = c._active;
        if (R && R !== Q) {
          R._domFocus = false;
          R._set(B, false, { src: t });
          c._active = null;
        }
        if (Q) {
          Q._domFocus = true;
              ...
              function (m) {
                ...
                if (n) {
                  if (n._filterUIEvent(m)) {
                    n.fire(m.type, { domEvent: m });
                  }
                }
              },
              "." + g.Widget.getClassName()
            );
            b[h] = k = { instances: {}, handle: j };
          }
          k.instances[g.stamp(this)] = 1;
        },
        _filterUIEvent: function (h) {
          return (
            h.currentTarget.compareTo(h.container) ||
            h.container.compareTo(this._getUIEventNode())
          );
        },
...
YUI.add(
  ...
  function (e) {
    ...
    a.ATTRS = {
      ...
      activeDescendant: { readOnly: true },
      multiple: {
        value: false,
    ...
    a.prototype = {
        ...
        if (h.get("parent") == this) {
          if (g.src != "_updateSelection") {
            ...
            if (!this.get("multiple") && f && g.newVal > 0) {
              f.set("selected", 0, { src: "_updateSelection" });
            }
            this._set("selection", h);
          }
          if (g.src == this) {
            this._set("selection", h, { src: this });
          }
        }
      },
      ...
      _createChild: function (f) {
        ...
        if (i) {
          ...
          e.error(
            "Could not create a child instance because its constructor is either undefined or invalid."
          );
        }
        return j;
      },
      ...
      _add: function (j, f) {
        ...
        if (c.isArray(j)) {
          ...
          if (i && this.fire("addChild", { child: i, index: f })) {
            h = i;
          }
        }
        return h;
      ...
      remove: function (f) {
        var h = this._items[f],
          g;
        if (h && this.fire("removeChild", { child: h, index: f })) {
          g = h;
        }
        return g;
      },
  ...
  function (c) {
    ...
    a.prototype = {
      _init: function (d, f) {
        ...
        this._requests = {};
        this._timeouts = {};
        f = b(f) ? { on: { success: f } } : f || {};
        var e = f.on || {};
        if (!e.success) {
          e.success = this._defaultCallback(d, f);
        }
        this._config = c.merge(
          { context: this, args: [], format: this._format, allowCache: false },
          f,
          { on: e }
        );
      },
      ...
      send: function () {
        ...
        if (d._requests[h] === undefined) {
          d._requests[h] = 0;
        }
        if (d._timeouts[h] === undefined) {
          d._timeouts[h] = 0;
        }
        d._requests[h]++;
        g.unshift(d.url, "YUI.Env.JSONP." + h);
        e = f.format.apply(d, g);
        if (!f.on.success) {
          return d;
        }
        function i(k, j) {
          return b(k)
            ? function (n) {
                ...
                if (!d._requests[h] && !d._timeouts[h]) {
                  delete YUI.Env.JSONP[h];
                }
                if (m) {
                  k.apply(f.context, [n].concat(f.args));
                }
              }
            : null;
        }
        YUI.Env.JSONP[h] = i(f.on.success);
        c.Get.script(e, {
          onFailure: i(f.on.failure),
          onTimeout: i(f.on.timeout, true),
          timeout: f.timeout,
          charset: f.charset,
      ...
      _format: function (d, e) {
        return d.replace(/\{callback\}/, e);
      },
    };
    c.JSONPRequest = a;
    c.jsonp = function (d, f) {
      var e = new c.JSONPRequest(d, f);
      return e.send.apply(e, c.Array(arguments, 2, true));
    };
    if (!YUI.Env.JSONP) {
      YUI.Env.JSONP = {};
    }
  ...
  function (b) {
    ...
    b.Anim.behaviors.xy = {
      set: function (f, d, i, h, c, g, e) {
        f._node.setXY([
          e(c, a(i[0]), a(h[0]) - a(i[0]), g),
          e(c, a(i[1]), a(h[1]) - a(i[1]), g),
        ]);
      },
      get: function (c) {
  ...
  function (b) {
    ...
    b.Anim.behaviors.scroll = {
      set: function (f, g, i, j, k, e, h) {
        var d = f._node,
          c = [
            h(k, a(i[0]), a(j[0]) - a(i[0]), e),
            h(k, a(i[1]), a(j[1]) - a(i[1]), e),
          ];
        if (c[0]) {
...
YUI.add(
  ...
  function (f) {
    var b = f.Env.evt.dom_wrappers,
      ...
      a = {
        ...
        _notify: function (k, i, h) {
          ...
          if (g !== j && !d(g, j)) {
            h.fire(
              new f.DOMEventFacade(k, g, b["event:" + f.stamp(g) + k.type])
            );
          }
        },
        on: function (k, i, j) {
    ...
    f.Event.define(
      "mouseleave",
      f.merge(a, { proxyType: "mouseout", relProperty: "toElement" }),
      true
    );
  },
  "3.18.1",
    ...
    d.prototype = {
      ...
      init: function (v, u) {
        ...
        if (!w._running && u) {
          ...
          v._transition = w;
          w._duration =
            "duration" in u ? u.duration : w.constructor.DEFAULT_DURATION;
      ...
      addProperty: function (v, x) {
        ...
        A._count++;
        u =
          (typeof x.duration != "undefined" ? x.duration : A._duration) ||
          0.0001;
        F[v] = {
          value: w,
          duration: u,
      ...
      run: function (y) {
        var x = this,
          v = x._node,
          u = x._config,
          w = { type: "transition:start", config: u };
        if (!x._running) {
          x._running = true;
          if (u.on && u.on.start) {
      ...
      _runNative: function (w) {
        var C = this,
          ...
          E = b.stamp(x),
          v = x.style,
          A = x.ownerDocument.defaultView.getComputedStyle(x),
          I = d._nodeAttrs[E],
          y = "",
          J = A[d._toCamel(j)],
          H = j + ": ",
      ...
      _end: function (u) {
        var y = this,
          ...
          A = y._callback,
          v = y._config,
          x = { type: "transition:end", config: v, elapsedTime: u },
          z = b.one(w);
        y._running = false;
        y._callback = null;
        if (w) {
      ...
      _endNative: function (u) {
        var v = this._node,
          w = v.ownerDocument.defaultView.getComputedStyle(v, "")[
            d._toCamel(j)
          ];
        u = d._toHyphen(u);
        if (typeof w === "string") {
      ...
      a.prototype,
      {
        ...
        _runAttrs: function (e) {
          ...
          for (w in m) {
            if ((j = m[w]) && j.transition === o) {
              ...
              q = p in h && "set" in h[p] ? h[p].set : a.DEFAULT_SETTER;
              l = k >= r;
              if (k > r) {
                k = r;
              }
              if (!s || e >= s) {
                q(o, w, j.from, j.to, k - s, r - s, j.easing, j.unit);
                if (l) {
                  delete m[w];
                  o._count--;
                  if (u[w] && u[w].on && u[w].on.end) {
                    u[w].on.end.call(b.one(n), v);
                  }
                  if (!g && o._count <= 0) {
                    g = true;
                    o._end(c);
        ...
        _initAttrs: function () {
          var j = this,
            ...
            h;
          for (c in q) {
            if ((d = q[c]) && d.transition === j) {
              i = d.duration * 1000;
              k = d.delay * 1000;
              n = d.easing;
              g = d.value;
              if (c in j._node.style || c in b.DOM.CUSTOM_STYLES) {
                f =
                  c in e && "get" in e[c]
                    ? e[c].get(j, c)
                    : a.DEFAULT_GETTER(j, c);
                o = a.RE_UNITS.exec(f);
                m = a.RE_UNITS.exec(g);
                f = o ? o[1] : f;
                h = m ? m[1] : g;
    ...
    b.mix(
      b.Transition,
      {
        ...
        behaviors: {
          left: {
            get: function (d, c) {
              return b.DOM._getAttrOffset(d._node, c);
            },
          },
        },
        DEFAULT_SETTER: function (f, g, i, j, l, e, h, k) {
          ...
          c = i + c[0] * (j - i);
          if (d) {
            if (g in d.style || g in b.DOM.CUSTOM_STYLES) {
              k = k || "";
              b.DOM.setStyle(d, g, c + k);
            }
          } else {
            f._end();
          }
        ...
        DEFAULT_GETTER: function (e, c) {
          var d = e._node,
            f = "";
          if (c in d.style || c in b.DOM.CUSTOM_STYLES) {
            f = b.DOM.getComputedStyle(d, c);
          }
          return f;
        },
...
YUI.add(
  ...
  function (e) {
    var j =
      ...
      k = function (H, F, G) {
        var D = G ? 4 : 3,
          E = F.length > D ? e.merge(F.splice(D, 1)[0]) : {};
        if (!(u in E)) {
          E[u] = H.PREVENT_DEFAULT;
        }
        return E;
      },
      f = function (E, D) {
        return D._extra.root || E.get(q) === 9 ? E : E.get(v);
      },
      y = function (D, F, E) {
        D.pageX = F.pageX;
        D.pageY = F.pageY;
    ...
    d(i, {
      on: function (E, D, F) {
        D[B] = E.on(j[x], this._onStart, this, E, D, F);
      },
      delegate: function (F, E, H, D) {
        var G = this;
        E[r] = F.delegate(
          j[x],
          function (I) {
            G._onStart(I, F, E, H, true);
          },
          D
        );
      },
      detachDelegate: function (F, E, H, D) {
        var G = E[r];
        if (G) {
          G.detach();
          E[r] = null;
      ...
      processArgs: function (D, E) {
        var F = k(this, D, E);
        if (!(z in F)) {
          F[z] = this.MIN_TIME;
        }
        if (!(t in F)) {
          F[t] = this.MIN_DISTANCE;
        }
        return F;
      },
      _onStart: function (J, E, P, D, L) {
        if (L) {
          E = J[n];
        }
        var F = P._extra,
        ...
        if (O) {
          ...
          if (G === 0 || N === 0) {
            ...
            K = [J.pageX, J.pageY];
            if (G > 0) {
              F._ht = e.later(G, this, this._start, [J, E, D, F]);
              F._hme = M.on(
                j[h],
                e.bind(function () {
                  this._cancel(F);
            ...
            if (N > 0) {
              F._hm = M.on(
                ...
                e.bind(function (Q) {
                  if (
                    Math.abs(Q.pageX - K[0]) > N ||
                    Math.abs(Q.pageY - K[1]) > N
                  ) {
                    this._start(J, E, D, F);
                  }
                }, this)
    ...
    d(l, {
      on: function (F, E, H) {
        var D = f(F, E),
          G = D.on(j[C], this._onMove, this, F, E, H);
        E[m] = G;
      },
      delegate: function (F, E, H, D) {
        var G = this;
      ...
      _onMove: function (J, H, G, I, F) {
        if (F) {
          H = J[n];
        }
        var D = G._extra.standAlone || H.getData(g),
          E = G._extra.preventDefault;
        if (D) {
          if (J.touches) {
            if (J.touches.length === 1) {
              y(J, J.touches[0]);
    ...
    d(a, {
      on: function (G, F, H) {
        var E = f(G, F),
          D = E.on(j[h], this._onEnd, this, G, F, H);
        F[w] = D;
      },
      delegate: function (F, E, H, D) {
        var G = this;
      ...
      _onEnd: function (J, H, F, I, E) {
        if (E) {
          H = J[n];
        }
        var G = F._extra.standAlone || H.getData(s) || H.getData(g),
          D = F._extra.preventDefault;
        if (G) {
          if (J.changedTouches) {
            if (J.changedTouches.length === 1) {
              y(J, J.changedTouches[0]);
            } else {
              G = false;
            }
          }
    ...
    f.compileFilter = a.cached(function (j) {
      return function (l, k) {
        return g(
          l._node,
          j,
          k.currentTarget === k.target ? null : k.currentTarget._node
        );
      };
    });
...
YUI.add(
  ...
  function (g) {
    ...
    c._build = function (h, o, t, x, w, q) {
      var y = c._build,
        j = y._ctor(o, q),
        m = y._cfg(o, q, t),
        v = y._mixCust,
        k = j._yuibuild.dynamic,
        p,
        n,
        u,
        z,
      ...
      for (p = 0, n = t.length; p < n; p++) {
        ...
        j._yuibuild.exts.push(u);
      }
      if (x) {
        g.mix(j.prototype, x, true);
      }
      if (w) {
        g.mix(j, y._clean(w, m), true);
        v(j, w, m);
      }
      j.prototype.hasImpl = y._impl;
      if (k) {
        j.NAME = h;
    ...
    g.mix(f, {
      _mixCust: function (h, t, p) {
        ...
        if (o) {
          for (n = 0, m = o.length; n < m; n++) {
            k = o[n];
            if (!h.hasOwnProperty(k) && t.hasOwnProperty(k)) {
              h[k] = a.isArray(t[k]) ? [] : {};
            }
            g.aggregate(h, t, true, [k]);
          }
        }
        if (j) {
          for (n in j) {
      ...
      _ctor: function (h, i) {
        var k = i && false === i.dynamic ? false : true,
          l = k ? f._tmpl(h) : h,
          j = l._yuibuild;
        if (!j) {
          j = l._yuibuild = {};
      ...
      _cfg: function (m, q, n) {
        ...
        while (s && s.prototype) {
          ...
          if (h) {
            if (h.aggregates) {
              k = k.concat(h.aggregates);
            }
            if (h.custom) {
              g.mix(p, h.custom, true);
            }
            if (h.statics) {
              v = v.concat(h.statics);
            }
          }
          s = s.superclass ? s.superclass.constructor : null;
        }
        if (n) {
        ...
        if (u) {
          g.mix(p, q.cfgBuild, true);
        }
        if (r) {
          v = v.concat(r);
        }
        return { aggregates: k, custom: p, statics: v };
      },
      _clean: function (q, j) {
        var p,
          k,
    ...
    c.build = function (j, h, k, i) {
      return f(j, h, k, null, null, i);
    };
    c.create = function (h, k, j, i, l) {
      return f(h, k, j, i, l);
    };
    c.mix = function (h, i) {
      return f(null, h, i, null, null, { dynamic: false });
    };
    c._buildCfg = {
      custom: {
        ATTRS: function (m, k, i) {
          k.ATTRS = k.ATTRS || {};
          if (i.ATTRS) {
            var j = i.ATTRS,
              l = k.ATTRS,
...
YUI.add(
  ...
  function (f) {
    var d = f.Event,
      ...
      e = f.Array.indexOf,
      b = c.isFunction(
        f.DOM.create('<p onbeforeactivate=";"/>').onbeforeactivate
      );
    function g(i, h, k) {
      var j = "_" + i + "Notifiers";
      f.Event.define(
  ...
  function (c) {
    ...
    s.prototype = {
      ...
      _getStateVal: function (v) {
        ...
        return w && v in w && !this._state.get(v, h)
          ? w[v]
          : this._state.get(v, f);
      },
...
YUI.add(
  ...
  function (a) {
    ...
    n.NAME = "baseCore";
    n.ATTRS = {
      initialized: { readOnly: true, value: false },
      destroyed: { readOnly: true, value: false },
    };
    n.prototype = {
      ...
      if (!l.addEventListener && !l.attachEvent) {
        p(
          ...
          function (t, o) {
            if (
              (o || o === 0) &&
              (!r || r.call(s || this, t, o, this, l) !== false)
            ) {
              if (o !== a) {
                if (o == "prototype") {
                } else {
  ...
  function (b) {
    ...
    b.CustomEvent.prototype = {
      ...
      on: function (t, s) {
        var r = arguments.length > 2 ? b.Array(arguments, 2, true) : null;
        if (this.host) {
          this.host._monitor("attach", this.type, { args: arguments });
        }
        return this._on(t, s, r, true);
      },
      after: function (t, s) {
      ...
      _delete: function (r) {
        ...
        if (this.host) {
          this.host._monitor("detach", this.type, { ce: this, sub: r });
        }
        if (r) {
          r.deleted = true;
        }
    ...
    d.prototype = {
      ...
      on: function (v, A, t) {
        ...
        if (!H) {
          ...
          H = C._on(
            A,
            t,
            arguments.length > 3 ? k(arguments, 3, true) : null,
            u ? "after" : true
          );
        }
        if (B) {
      ...
      _monitor: function (u, r, v) {
        var s,
          t = this.getEvent(r);
        if (
          (this._yuievt.config.monitored && (!t || t.monitored)) ||
          (t && t.monitored)
        ) {
          s = r + "_" + u;
          v.monitored = u;
      ...
      fire: function (v) {
        ...
        if (!y) {
          if (this._yuievt.hasTargets) {
            return this.bubble({ type: u }, r, this);
          }
          s = true;
        } else {
          y.sibling = w;
  ...
  function (f) {
    ...
    a.fireComplex = function (p) {
      ...
      if (t.prevented) {
        ...
        if (
          t.defaultFn &&
          ((!t.defaultTargetOnly && !r.defaultTargetOnly) || s === l.target)
        ) {
...
YUI.add(
  ...
  function (f) {
    var a = "broadcast",
      d = "published",
      e = "initValue",
      c = { readOnly: 1, writeOnce: 1, getter: 1, broadcast: 1 };
    function b() {}
    b.prototype = {
      ...
      reset: function (g) {
        ...
        if (g) {
          ...
          f.each(h._state.data, function (i, j) {
            h.reset(j);
          });
        }
        return h;
...
YUI.add(
  ...
  function (b) {
    ...
    b.AttributeComplex = b.Attribute.Complex;
  },
  "3.18.1",
...
YUI.add(
  ...
  function (b) {
    ...
    d._NON_ATTRS_CFG = j._NON_ATTRS_CFG.concat([
      "on",
      "after",
      "bubbleTargets",
    ]);
  ...
  function (b) {
    ...
    if (!k("value-set", "select")) {
      g.VALUE_SETTERS.select = function (u, v) {
        for (
          var s = 0, r = u.getElementsByTagName("option"), t;
          (t = r[s++]);
    ...
    b.mix(g.VALUE_GETTERS, {
      button: function (r) {
        return r.attributes && r.attributes.value
    ...
    b.mix(b.DOM, {
      ...
      removeClass: function (s, r) {
        if (r && f(s, r)) {
          s.className = b.Lang.trim(
            s.className.replace(
              b.DOM._getRegExp("(?:^|\\s+)" + r + "(?:\\s+|$)"),
              " "
            )
          );
          if (f(s, r)) {
      ...
      d.Color = {
        ...
        toRGB: function (e) {
          ...
          if (d.Color.re_hex.exec(e)) {
            e =
              "rgb(" + [b(c.$1, 16), b(c.$2, 16), b(c.$3, 16)].join(", ") + ")";
          }
          return e;
        },
        toHex: function (f) {
          ...
          if (d.Color.re_RGB.exec(f)) {
            f = [
              Number(c.$1).toString(16),
              Number(c.$2).toString(16),
              Number(c.$3).toString(16),
            ];
  ...
  function (a) {
    (function (e) {
      ...
      var b = {
        ...
        _compare:
          "sourceIndex" in e.config.doc.documentElement
            ? function (i, h) {
                var g = i.sourceIndex,
                  f = h.sourceIndex;
                if (g === f) {
        ...
        _replaceSelector: function (f) {
          ...
          return { esc: g, attrs: h, pseudos: i, selector: f };
        },
...
YUI.add("selector", function (a) {}, "3.18.1", {
  requires: ["selector-native"],
});
    ...
    c.mix(
      k.prototype,
      {
        ...
        ancestor: function (q, s, r) {
          if (
            arguments.length === 2 &&
            (typeof s == "string" || typeof s == "function")
          ) {
            r = s;
          }
        ...
        replaceChild: function (r, q) {
          ...
          return c.one(
            this._node.replaceChild(k.getDOMNode(r), k.getDOMNode(q))
          );
        },
        destroy: function (s) {
  ...
  function (e) {
    ...
    if (!e.config.doc.documentElement.hasAttribute) {
      e.Node.prototype.hasAttribute = function (f) {
        ...
        return !!(
          this._node.attributes[f] && this._node.attributes[f].specified
        );
      };
    }
...
YUI.add(
  "event-base",
  function (e) {
    e.publish("domready", { fireOnce: true, async: true });
    if (YUI.Env.DOMReady) {
      e.fire("domready");
    } else {
      e.Do.before(
    ...
    e.extend(f, Object, {
      init: function () {
        ...
        if (i.type == "mousewheel" || i.type == "DOMMouseScroll") {
          this.wheelDelta = i.detail
            ? i.detail * -1
            : Math.round(i.wheelDelta / 80) || (i.wheelDelta < 0 ? -1 : 1);
        }
        if (this._touch) {
        ...
        r = (function () {
          ...
          return {
            ...
            getEvent: function (C, A, z) {
              ...
              return z
                ? B
                : new e.DOMEventFacade(B, A, x["event:" + e.stamp(A) + C.type]);
            },
            ...
            _poll: function () {
              ...
              for (A = 0, z = u.length; A < z; ++A) {
                ...
                if (E && !E.checkReady) {
                  B = E.compat
                    ? e.DOM.byId(E.id)
                    : e.Selector.query(E.id, null, true);
                  if (B) {
                    F(B, E);
                    u[A] = null;
                  } else {
...
YUI.add(
  ...
  function (a) {
    (function (b) {
      ...
      b.NodeList.importMethod(b.Node.prototype, [
        "getStyle",
        "getComputedStyle",
        "setStyle",
        "setStyles",
...
YUI.add(
  ...
  function (b) {
    ...
    b.Anim.DEFAULT_SETTER = function (t, u, w, x, z, s, v, y) {
      var q = t._node,
        r = q._node,
        p = v(z, a(w), a(x) - a(w), s);
      if (r && (r.style || r.attributes)) {
        if (u in r.style || u in b.DOM.CUSTOM_STYLES) {
          y = y || "";
          q.setStyle(u, p + y);
        } else {
          if (r.attributes[u]) {
    ...
    b.Anim.DEFAULT_GETTER = function (s, p) {
      var r = s._node,
        q = r._node,
        t = "";
      if (q && (q.style || q.attributes)) {
        if (p in q.style || p in b.DOM.CUSTOM_STYLES) {
          t = r.getComputedStyle(p);
        } else {
          if (q.attributes[p]) {
            t = r.getAttribute(p);
          }
    ...
    b.Anim.ATTRS = {
      ...
      elapsedTime: { value: 0, readOnly: true },
      running: {
        getter: function () {
    ...
    b.Anim.behaviors.color = {
      set: function (f, d, i, h, c, g, e) {
        ...
        f._node.setStyle(
          ...
          "rgb(" +
            [
              Math.floor(e(c, a(i[1]), a(h[1]) - a(i[1]), g)),
              Math.floor(e(c, a(i[2]), a(h[2]) - a(i[2]), g)),
              Math.floor(e(c, a(i[3]), a(h[3]) - a(i[3]), g)),
            ].join(", ") +
            ")"
        );
      },
  ...
  function (a) {
    (function () {
      var k = a.Lang,
        ...
        c = { blur: 1, change: 1, focus: 1, resize: 1, scroll: 1, select: 1 },
        e = {
          scroll: 1,
          resize: 1,
          reset: 1,
      ...
      function i(v, z, u, s, B, r, q, A, x, D, C) {
        ...
        if (d(z)) {
          ...
          switch (z) {
            ...
            default:
              a.error(
                "simulateKeyEvent(): Event type '" + z + "' not supported."
              );
          }
        } else {
      ...
      function b(A, F, x, u, G, z, w, v, t, r, s, q, E, C, y, B) {
        ...
        if (d(F)) {
          ...
          if (!p[F]) {
            a.error(
              "simulateMouseEvent(): Event type '" + F + "' not supported."
            );
          }
        } else {
