...
function announceAJAXValidationErrors() {
  ...
  jQuery(".gform_validation_errors").length &&
    ((e = document.querySelector('[data-js="gform-focus-validation-error"]')) &&
    ...
    (this.htmlDecode = function (e) {
      ...
      if (null != n)
        for (var o = 0; o < n.length; o++)
          i =
            -32768 <= (t = (r = n[o]).substring(2, r.length - 1)) && t <= 65535
  ...
  return (
    (gformIsProductSelected(e, t) &&
      ...
      (0 < n.length
        ...
        : ((r = 1),
          0 <
            (n = jQuery(".gfield_quantity_" + e + "_" + t + " :input"))
              .length &&
            ((r = n.val()),
...
function gformFormatPricingField(e) {
  ...
  gf_global.gf_currency_config &&
    ((t = new Currency(gf_global.gf_currency_config).toMoney(jQuery(e).val())),
    jQuery(e).val(t));
}
                    ...
                    if (void 0 !== t) {
                      ...
                      if (r) {
                        ...
                        var f = e.attr("id"),
                          ...
                          f =
                            (f &&
                              (f = f.match(/((choice|input)_[0-9|_]*)-/)) &&
                              f[2] &&
                              ((s = f[1] + s),
                              d.attr("for", s),
                              e.attr("id", s)),
        ...
        switch (((a = ""), r)) {
          ...
          case "qty":
            if (n.hasClass("gfield_price"))
              return !1 === (d = gformGetProductQuantity(e, i)) || "" === d
                ? 0
                : d;
        }
        if (
          ...
          for (var f, d = [], c = 0; c < o.length; c++)
            "checkbox" === o.prop("type") && "" === r
              ? ((f = jQuery(o[c]).next("label").clone()).find("span").remove(),
                (d[c] = GFMergeTag.formatValue(f.text(), r)),
                f.remove())
          ...
          0 < l && l <= s
            ...
            : (m.each(e, function (e, t) {
              ...
              0 < l &&
                ...
                d(o.settings.gf_vars.message_id, _.max_reached)),
        ...
        t.bind("Error", function (e, t) {
          ...
          t.code === plupload.FILE_EXTENSION_ERROR
            ...
            : ((r =
              ...
              d(e.settings.gf_vars.message_id, r)),
            m("#" + t.file.id).html(""),
            e.refresh();
        }),
    ...
    function (e) {
      ...
      !o && (a || n) && (l || i)
        ...
        : a &&
          ...
          !(n =
            0 === (n = t.find('input[name="g-recaptcha-response"]')).length
