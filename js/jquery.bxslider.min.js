      ...
      return (
        (s = function () {
          R(L).data("bxSlider") ||
            ...
            L.children(D.settings.slideSelector).each(function () {
        ...
        (t = function () {
          ...
          L.wrap(
            ...
            D.viewport.parent().css({ maxWidth: r() }),
            D.settings.pager ||
              D.settings.controls ||
            ...
            D.settings.captions && m(),
            (D.active.last = D.settings.startSlide === c() - 1),
            D.settings.video && L.fitVids(),
        ...
        (o = function () {
          ...
          D.settings.infiniteLoop &&
            ...
            L.append(t).prepend(e)),
            D.loader.remove(),
            h(),
            "vertical" === D.settings.mode && (D.settings.adaptiveHeight = !0),
            D.viewport.height(a()),
            L.redrawSlider(),
            D.settings.onSliderLoad.call(L, D.active.index),
            (D.initialized = !0),
            D.settings.responsive && R(window).bind("resize", H),
            D.settings.auto &&
              D.settings.autoStart &&
              (1 < c() || D.settings.autoSlideForOnePage) &&
              z(),
            D.settings.ticker && O(),
            D.settings.pager && E(D.settings.startSlide),
            D.settings.controls && y(),
            "ontouchstart" in window && N(),
            D.settings.keyboardEnabled &&
              !D.settings.ticker &&
              R(document).keydown(I);
        }),
        (a = function () {
          var e = 0,
            t = R();
          if ("vertical" === D.settings.mode || D.settings.adaptiveHeight)
            if (D.carousel) {
              ...
              for (i = 1; i <= D.settings.maxSlides - 1; i++)
                t =
                  s + i >= D.children.length
                    ? t.add(D.children.eq(i - 1))
                    : t.add(D.children.eq(s + i));
          ...
          return (
            "vertical" === D.settings.mode
              ? (t.each(function (t) {
                ...
                0 < D.settings.slideMargin &&
                  (e += D.settings.slideMargin * (D.settings.minSlides - 1)))
              : (e = Math.max.apply(
                  Math,
                  t
                    .map(function () {
            ...
            "horizontal" === D.settings.mode && 0 < D.settings.slideWidth
              ? (e =
                  D.viewport.width() < D.minThreshold
                    ...
                    ? D.settings.maxSlides
                    : ((t =
                        D.children.first().width() + D.settings.slideMargin),
                      Math.floor(
                        (D.viewport.width() + D.settings.slideMargin) / t
                      )))
              : "vertical" === D.settings.mode && (e = D.settings.minSlides),
            e
          );
        }),
        (c = function () {
            ...
            if (D.settings.infiniteLoop) t = Math.ceil(D.children.length / g());
              ...
              for (; e < D.children.length; )
                ++t,
                  (e = i + d()),
                  (i +=
                    D.settings.moveSlides <= d() ? D.settings.moveSlides : d());
          else t = Math.ceil(D.children.length / d());
          return t;
        }),
        (g = function () {
          return 0 < D.settings.moveSlides && D.settings.moveSlides <= d()
          ...
          !D.settings.infiniteLoop
            ? "horizontal" === D.settings.mode
              ...
              : "vertical" === D.settings.mode &&
                ...
                p(-t.top, "reset", 0))
            : ((t = D.children.eq(D.active.index * g()).position()),
              D.active.index === c() - 1 && (D.active.last = !0),
              void 0 !== t &&
                ("horizontal" === D.settings.mode
                  ? p(-t.left, "reset", 0)
                  : "vertical" === D.settings.mode && p(-t.top, "reset", 0)));
        }),
        (p = function (t, e, i, s) {
          var n;
          D.usingCSS
            ? ((n =
              ...
              L.css("-" + D.cssPrefix + "-transition-duration", i / 1e3 + "s"),
              "slide" === e
                ? (L.css(D.animProp, n),
                  0 !== i
                    ? L.bind(
            ...
            : (((n = {})[D.animProp] = t),
              "slide" === e
                ? L.animate(n, i, D.settings.easing, function () {
                    k();
                  })
                : "reset" === e
                ? L.css(D.animProp, t)
                : "ticker" === e &&
                  L.animate(n, i, "linear", function () {
                    p(s.resetValue, "reset", 0), M();
                  }));
        }),
        (u = function () {
          for (var t = "", e = "", i = c(), s = 0; s < i; s++)
            (e = ""),
              (D.settings.buildPager &&
                "function" == typeof D.settings.buildPager) ||
              D.settings.pagerCustom
                ? ((e = D.settings.buildPager(s)),
                  D.pagerEl.addClass("bx-custom-pager"))
                : ((e = s + 1), D.pagerEl.addClass("bx-default-pager")),
              (t +=
        ...
        (v = function () {
          D.settings.pagerCustom
            ...
            : ((D.pagerEl = R('<div class="bx-pager" />')),
              ...
              u()),
            D.pagerEl.on("click touchend", "a", T);
        }),
        (f = function () {
          (D.controls.next = R(
            ...
            D.controls.next.bind("click touchend", S),
            D.controls.prev.bind("click touchend", b),
        ...
        (x = function () {
          (D.controls.start = R(
            ...
            D.controls.autoEl.on("click", ".bx-start", w),
            ...
            P(D.settings.autoStart ? "stop" : "start");
        }),
        (m = function () {
        ...
        (S = function (t) {
          t.preventDefault(),
            D.controls.el.hasClass("disabled") ||
              (D.settings.auto && D.settings.stopAutoOnClick && L.stopAuto(),
              L.goToNextSlide());
        }),
        (b = function (t) {
          t.preventDefault(),
        ...
        (T = function (t) {
          t.preventDefault(),
            D.controls.el.hasClass("disabled") ||
              (D.settings.auto && D.settings.stopAutoOnClick && L.stopAuto(),
              void 0 !== (t = R(t.currentTarget)).attr("data-slide-index") &&
                (t = parseInt(t.attr("data-slide-index"))) !== D.active.index &&
                L.goToSlide(t));
        }),
        (E = function (i) {
          ...
          if ("short" === D.settings.pagerType)
            return (
              ...
              void D.pagerEl.html(i + 1 + D.settings.pagerShortSeparator + t)
            );
        ...
        (k = function () {
          ...
          D.settings.infiniteLoop &&
            ...
            0 === D.active.index
              ...
              : D.active.index === c() - 1 && D.carousel
              ? (t = D.children.eq((c() - 1) * g()).position())
        ...
        (z = function () {
          0 < D.settings.autoDelay
            ? setTimeout(L.startAuto, D.settings.autoDelay)
            : (L.startAuto(),
              R(window)
                .focus(function () {
                  L.startAuto();
        ...
        (O = function () {
          ...
          "next" === D.settings.autoDirection
            ? L.append(D.children.clone().addClass("bx-clone"))
            : (L.prepend(D.children.clone().addClass("bx-clone")),
            ...
            D.settings.tickerHover &&
              (D.usingCSS
                ? ((s = "horizontal" === D.settings.mode ? 4 : 5),
                  D.viewport.hover(
                    function () {
                      (e = L.css("-" + D.cssPrefix + "-transform")),
                        (i = parseFloat(e.split(",")[s])),
                        p(i, "reset", 0);
                    },
                    function () {
                      (a = 0),
                        ...
                        (n = D.settings.speed / a),
                        (o = "horizontal" === D.settings.mode ? "left" : "top"),
                        (r = n * (a - Math.abs(parseInt(i)))),
                        M(r);
                    }
                  ))
                : D.viewport.hover(
                    ...
                    function () {
                      (a = 0),
                        ...
                        (n = D.settings.speed / a),
                        (o = "horizontal" === D.settings.mode ? "left" : "top"),
                        (r = n * (a - Math.abs(parseInt(L.css(o))))),
                        M(r);
                    }
                  )),
            M();
        ...
        (I = function (t) {
          ...
          if (null == new RegExp(e, ["i"]).exec("input|textarea") && F(L))
            return 39 === t.keyCode
              ? (S(t), !1)
              : 37 === t.keyCode
              ? (b(t), !1)
        ...
        (N = function () {
          (D.touch = { start: { x: 0, y: 0 }, end: { x: 0, y: 0 } }),
            D.viewport.bind("touchstart", X),
            D.viewport.on("click", ".bxslider a", function (t) {
              D.viewport.hasClass("click-disabled") &&
                (t.preventDefault(), D.viewport.removeClass("click-disabled"));
            });
        }),
        (X = function (t) {
          D.controls.el.addClass("disabled"),
            D.working
              ? (t.preventDefault(), D.controls.el.removeClass("disabled"))
              : ((D.touch.originalPos = L.position()),
                (t =
                ...
                D.viewport.bind("touchmove", q),
                D.viewport.bind("touchend", A));
        }),
        (q = function (t) {
          var e = t.originalEvent,
            ...
            n = 0,
            o = 0;
          ((s < 3 * i && D.settings.preventDefaultSwipeX) ||
            (i < 3 * s && D.settings.preventDefaultSwipeY)) &&
            t.preventDefault(),
            "fade" !== D.settings.mode &&
        ...
        (A = function (t) {
          ...
          (D.touch.end.x = e[0].pageX),
            ...
            "fade" === D.settings.mode
              ? (s = Math.abs(D.touch.start.x - D.touch.end.x)) >=
              ...
              : ((i =
                  "horizontal" === D.settings.mode
                    ? ((s = D.touch.end.x - D.touch.start.x),
                      D.touch.originalPos.left)
                    : ((s = D.touch.end.y - D.touch.start.y),
                      D.touch.originalPos.top)),
                (D.settings.infiniteLoop ||
                  !(
                    (0 === D.active.index && 0 < s) ||
                    (D.active.last && s < 0)
                  )) &&
                Math.abs(s) >= D.settings.swipeThreshold
                  ? (s < 0 ? L.goToNextSlide() : L.goToPrevSlide(),
                    L.stopAuto())
                  : p(i, "reset", 200)),
            D.viewport.unbind("touchend", A),
            ...
            (D.working
              ...
              : ((e = R(window).width()),
                ...
                (Y === e && V === i) ||
                  ...
                  (V = i),
                  L.redrawSlider(),
                  D.settings.onSliderResize.call(L, D.active.index))));
        }),
        (W = function (t) {
          var e = d();
          D.settings.ariaHidden &&
        ...
        (L.goToSlide = function (t, e) {
          ...
          if (
            ...
            if (
              ((D.working = !0),
              void 0 !==
                (s = D.settings.onSlideBefore.call(
                  L,
                  D.children.eq(D.active.index),
                  D.oldIndex,
                  D.active.index
            ...
            "next" === e
              ...
              : "prev" !== e ||
                ...
                (s = !1),
              (D.active.last = D.active.index >= c() - 1),
                  ...
                  !D.settings.infiniteLoop && D.carousel && D.active.last
                    ? "horizontal" === D.settings.mode
                      ? ((o = (r = D.children.eq(
                        ...
                        (n = D.viewport.width() - r.outerWidth()))
                      : ((i = D.children.length - D.settings.minSlides),
                        (o = D.children.eq(i).position()))
                    : D.carousel && D.active.last && "prev" === e
                    ? ((s =
                        1 === D.settings.moveSlides
                          ? D.settings.maxSlides - g()
                          : (c() - 1) * g() -
                            (D.children.length - D.settings.maxSlides)),
                      (o = (r = L.children(".bx-clone").eq(s)).position()))
                  ...
                  void 0 !== o
                    ? ((s =
                        "horizontal" === D.settings.mode
                          ? -(o.left - n)
                          : -o.top),
                      p(s, "slide", D.settings.speed))
                    : (D.working = !1)),
              D.settings.ariaHidden && W(D.active.index * g());
          }
        }),
        (L.goToNextSlide = function () {
          var t;
          (!D.settings.infiniteLoop && D.active.last) ||
            ((t = parseInt(D.active.index) + 1), L.goToSlide(t, "next"));
        }),
        (L.goToPrevSlide = function () {
          var t;
          (!D.settings.infiniteLoop && 0 === D.active.index) ||
            ((t = parseInt(D.active.index) - 1), L.goToSlide(t, "prev"));
        }),
        (L.startAuto = function (t) {
          D.interval ||
            ...
            D.settings.autoControls && !0 !== t && P("stop"));
        }),
        (L.stopAuto = function (t) {
          D.interval &&
            (clearInterval(D.interval),
            (D.interval = null),
            D.settings.autoControls && !0 !== t && P("start"));
        }),
        ...
        (L.redrawSlider = function () {
          D.children.add(L.find(".bx-clone")).outerWidth(l()),
            D.viewport.css("height", a()),
            D.settings.ticker || h(),
            D.active.last && (D.active.index = c() - 1),
            D.active.index >= c() && (D.active.last = !0),
            D.settings.pager &&
              !D.settings.pagerCustom &&
              (u(), E(D.active.index)),
            D.settings.ariaHidden && W(D.active.index * g());
        ...
        (L.destroySlider = function () {
          D.initialized &&
            ...
            clearInterval(D.interval),
            D.settings.responsive && R(window).unbind("resize", H),
            D.settings.keyboardEnabled && R(document).unbind("keydown", I),
