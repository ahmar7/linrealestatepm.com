  ...
  (FLTheme = {
          ...
          (i = new Image()),
            ...
            a.width() < window.themeopts.mobile_breakpoint
              ? "" != t &&
                ...
                (i.src = src),
                o.show())
              : "undefined" != typeof o.data("src") &&
                (o.attr("src", o.data("src")), o.css("width", ""));
        });
    },
    ...
    closeMenu: function (a) {
      var l,
        ...
        t = e(".fl-page").hasClass("fl-nav-offcanvas-active");
      void 0 !== a &&
        void 0 !== a.target &&
        ("dropdown" === n && o
          ? ((l = e(".navbar-collapse.in").closest(".fl-page-nav")),
            l.find(".navbar-toggle").trigger("click"))
          : "flyout" === n && t && e(".fl-offcanvas-close").trigger("click"));
    },
      ...
      e(".fl-page-nav .navbar-toggle").is(":visible")
        ? (n.off("mouseenter mouseleave"),
          e("body").hasClass("fl-submenu-toggle") &&
            (t = l.find("> ul li").has("ul.sub-menu")),
          t.find("> a").off().on("click", FLTheme._navItemClickMobile),
          t
        ...
        : (l.find("a").off("click", FLTheme._navItemClickMobile),
          ...
          FLTheme._isMobile()
            ? (n.hover(function () {}, FLTheme._navItemMouseout),
              o.on("click", FLTheme._navSubMenuToggleClick))
    ...
    _navItemClickMobile: function (a) {
      var l = e(this).closest(".fl-page-nav-collapse"),
        n = e(this).closest("li"),
        o = e(this).attr("href"),
        t = n.find("ul.sub-menu"),
        i = e(a.target).hasClass("fl-submenu-toggle-icon"),
        s = null;
      if (o && "#" !== o) {
        var r = o.split("#")[1];
      ...
      ("#" == o || i) && n.hasClass("fl-mobile-sub-menu-open")
        ? (a.preventDefault(),
          n.removeClass("fl-mobile-sub-menu-open"),
          t.hide())
        : n.hasClass("fl-mobile-sub-menu-open") ||
          ...
          i &&
            ...
            ((s = t.find("li.menu-item-has-children")),
    ...
    _setupCurrentNavItem: function (a) {
      var l = e(".fl-page-nav .navbar-nav"),
        ...
        t = l.closest(".fl-page-nav").find(".fl-offcanvas-close");
      null != o &&
        e("body").find(n).length > 0 &&
        (e(".current-menu-item").removeClass("current-menu-item"),
        o.parent().addClass("current-menu-item"),
        t && t.trigger("click"));
    },
        ...
        if (
          (0 !== a.closest(".fl-sub-menu-right").length
            ...
            ? ((t = l.is("ul.sub-menu")
                ? l.offset().left - o
                : a.offset().left - o),
              t <= 0 && a.addClass("fl-sub-menu-right"))
            : ((t = l.is("ul.sub-menu")
                ? l.offset().left + 2 * o
                : a.offset().left + o),
              t > i && a.addClass("fl-sub-menu-right")),
    ...
    _shrinkHeaderInit: function () {
      ...
      e("body").addClass("fl-shrink-header-enabled"),
        ...
        e(".fl-page-header-logo").imagesLoaded(function () {
          var o = e(".fl-logo-img"),
            t = o.height();
          "undefined" != typeof o.data("origHeight") &&
            (t = parseInt(o.data("origHeight"))),
            o.css("max-height", t),
            setTimeout(function () {
    ...
    _shrinkHeaderEnable: function () {
      ...
      if (a.width() >= window.themeopts.medium_breakpoint) {
        ...
        0 != o.length
          ? ((t += o.outerHeight()),
            (i = t + n),
            0 != e("body.admin-bar").length && (t += 32),
            l.css("top", t))
          : (i = n),
          l.prevAll(".fl-builder-content").length > 0 &&
            (FLTheme._initThemerLayoutFix(), (i = o.outerHeight())),
          0 === e(".fl-header-padding-top-custom").length &&
            e(".fl-page").css("padding-top", i),
    ...
    _toggleFixedHeader: function () {
      ...
      (t =
        0 === o.length
          ? a.scrollTop() > 200
          : a.scrollTop() > o.height() + o.offset().top),
        t && !n ? l.stop().fadeIn(200) : !t && n && l.stop().hide();
    },
    _centeredInlineLogo: function () {
      ...
      a.width() >= window.themeopts.medium_breakpoint &&
        ...
        (l.hasClass("fl-inline-logo-left") && t % 2 != 0
          ? o
              .children("li:nth( " + i + " )")
    ...
    _megaMenu: function () {
      ...
      a.find("li.mega-menu, li.mega-menu-disabled").each(function () {
        (o = e(this)),
          (t = o.find("> ul.sub-menu").outerWidth()),
          "undefined" != typeof o.data("megamenu-width") &&
            (t = o.data("megamenu-width")),
          (o.hasClass("mega-menu") && n < t) ||
          FLTheme._isResponsiveNavEnabled()
            ? (o.data("megamenu-width", t),
              FLTheme._isResponsiveNavEnabled() &&
                o.find("> ul.sub-menu").css("display", "block"),
              o.removeClass("mega-menu"),
              o.hasClass("mega-menu-disabled") ||
                o.addClass("mega-menu-disabled"))
            : o.hasClass("mega-menu-disabled") &&
              n >= t &&
              (o.find("> ul.sub-menu").css("display", ""),
              o.removeClass("mega-menu-disabled"),
              o.hasClass("mega-menu") || o.addClass("mega-menu"),
              o.addClass(
                "mega-menu-items-" + o.children("ul").children("li").length
              ));
      });
    },
    ...
    _setupMobileNavLayout: function () {
      ...
      FLTheme._isResponsiveNavEnabled() && l.is(":visible")
        ? (e("body").addClass("fl-responsive-nav-enabled"),
          ...
          0 === o.find(".fl-button-close").length &&
            o.prepend(
        ...
        : (l.attr("data-toggle", "collapse"),
          ...
          o.css("height", ""),
          o.css("top", ""),
          t.removeClass("fl-nav-offcanvas-active"),
