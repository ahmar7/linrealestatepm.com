!(function () {
  ...
  var m = { containers: [] },
    ...
    w = function () {
      ...
      return y.previousMessage === t && (t += "Â "), (y.previousMessage = t), t;
    },
    O = function () {
  ...
  var ct = function (t, e, n, r) {
    ...
    pt = function (t, e, n) {
      ...
      Object.defineProperty(o, "name", dt),
        Object.defineProperty(t, "toString", at(at({}, ft), {}, { value: o }));
    };
  function gt(t, e) {
    var n,
    ...
    return (function (t, e) {
      ...
      for (r = 0; r < d; r++)
        if ("string" == typeof t[r]) p += t[r];
          ...
          if (
            (Ot.not_type.test(i.type) &&
              Ot.not_primitive.test(i.type) &&
              n instanceof Function &&
              (n = n()),
            Ot.numeric_arg.test(i.type) && "number" != typeof n && isNaN(n))
          )
            throw new TypeError(
              St("[sprintf] expecting number but found %T", n)
            );
          ...
          Ot.json.test(i.type)
            ? (p += n)
            : (!Ot.number.test(i.type) || (l && !i.sign)
                ? (s = "")
                : ((s = l ? "+" : "-"),
                  (n = n.toString().replace(Ot.sign, ""))),
              (c = i.pad_char
                ? "0" === i.pad_char
                  ? "0"
                  : i.pad_char.charAt(1)
      ...
      (function (t) {
        ...
        for (; n; ) {
          if (null !== (e = Ot.text.exec(n))) r.push(e[0]);
            ...
            if (null === (e = Ot.placeholder.exec(n)))
            ...
            if (e[2]) {
              ...
              for (i.push(c[1]); "" !== (a = a.substring(c[0].length)); )
                if (null !== (c = Ot.key_access.exec(a))) i.push(c[1]);
                  ...
                  if (null === (c = Ot.index_access.exec(a)))
                    throw new SyntaxError(
                      "[sprintf] failed to parse named argument key"
                    );
                  i.push(c[1]);
    ...
    return (
      c.forEach(function (n, r) {
        n.startsWith("".concat(t, "=")) &&
          ((u = !0), e ? (c[r] = "".concat(t, "=").concat(e)) : c.splice(r, 1));
      }),
  ...
  var Ct = function () {
          ...
          m = (function (t, e) {
            ...
            return (
              (void 0 === m
                ...
                .forEach(function (t) {
                  "fadeIn" === t &&
                    ((c.opacity = g || 0), (u.opacity = h || 1)),
                    "fadeOut" === t &&
                      ((c.opacity = g || 1), (u.opacity = h || 0)),
                    "translateY" === t &&
          ...
          setTimeout(function () {
            u(),
              requestAnimationFrame(function () {
                r.animate(m, { duration: Number(g), easing: h }).onfinish =
                  function () {
                    !(function (t, e) {
                      var n,
                        r,
    ...
    Ht =
      ...
      (!Lt && !Nt && "undefined" !== window.webkitAudioContext),
    ...
    t.addEventListener("mousedown", function (n) {
      ...
      t.addEventListener("mouseup", function () {
        (e.isDown = !1),
          ...
          $t({ event: "gform-utils/horizontal-drag-ended", native: !1 }),
        ...
        if (e.isDown) {
          ...
          (t.scrollLeft = e.scrollLeft - r),
            e.moveEventTriggered ||
              ($t({ event: "gform-utils/horizontal-drag-started", native: !1 }),
  ...
  function le() {
    ...
    var e =
      "rtl" === window.getComputedStyle(t, null).getPropertyValue("direction");
  ...
  function ge() {
    var t = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : "";
    return (
      document.querySelectorAll("[data-load-chunk-".concat(t, "]")).length > 0
    );
  }
  var ve = function (t) {
      var e,
      ...
      n.instances &&
        t &&
        Zt("[data-simplebar]", !0, t, !0).forEach(function (t) {
          var e;
    ...
    be = function (t) {
      me[t] || (me[t] = { up: null, down: null });
    },
    we = function (t) {
      me[t].up && (window.cancelAnimationFrame(me[t].up), (me[t].up = null)),
        me[t].down &&
          (window.cancelAnimationFrame(me[t].down), (me[t].down = null));
    },
    Oe = function (t, e) {
      var n =
          arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : 400,
        r =
      ...
      var c = function c(u) {
        ...
        (t.style.maxHeight = "".concat(s, "px")),
          l < n
            ...
            : ((me[e].down = null), (t.style.maxHeight = "none"), r && r());
      };
      setTimeout(function () {
        me[e].down = window.requestAnimationFrame(c);
      }, he);
      ...
      var a = function a(c) {
        ...
        (t.style.maxHeight = "".concat(l, "px")),
          u < n
            ...
            : ((me[e].up = null), (t.style.maxHeight = "0"), r && r());
      };
      setTimeout(function () {
        me[e].up = window.requestAnimationFrame(a);
      }, he);
  ...
  function Le(t) {
    ...
    if ("function" != typeof t)
      throw new TypeError(
        "Expected the first argument to be a function, got `".concat(_(t), "`")
      );
    var n,
      r,
      o,
  ...
  var Fe = function (t, e, n, r) {
    ...
    return "function" == typeof t.addEventListener
      ...
      : "function" == typeof n
      ? Me.bind(null, document).apply(null, arguments)
  ...
  function He() {
    ...
    !(arguments.length > 2 && void 0 !== arguments[2]) || arguments[2]
      ? window.addEventListener("resize", Le(t, { wait: e }))
      : window.removeEventListener("resize", Le(t, { wait: e }));
  }
  function qe() {
    try {
